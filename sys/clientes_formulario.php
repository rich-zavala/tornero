	...
	if(isset($_POST[mysql_intervention])){
		...
		foreach($o as $oo){
			if(strlen($_POST[$oo])==0){
				switch($oo){
					case "nombre": $error[] = "Faltó llenar el campo 'Nombre'.";
					break;
					
					case "RFC": $error[] = "Faltó llenar el campo 'RFC'.";
					break;
					
					case "calle": $error[] = "Faltó llenar el campo 'Calle'.";
					break;
					
					case "noexterior": $error[] = "Faltó llenar el campo 'No. Exterior'.";
					break;
					
					case "colonia": $error[] = "Faltó llenar el campo 'Colonia'.";
					break;
					
					case "localidad": $error[] = "Faltó llenar el campo 'Localidad'.";
					break;
					
					case "municipio": $error[] = "Faltó llenar el campo 'Municipio'.";
					break;
					
					case "estado": $error[] = "Faltó llenar el campo 'Estado'.";
					break;
										
					case "cp": $error[] = "Faltó llenar el campo 'Código Postal'.";
					break;
	
					case "credito": $error[] = "Faltó llenar el campo 'Crédito'.";
					break;
	
					case "dias_credito": $error[] = "Faltó llenar el campo 'Días de Crédito'.";
					break;
				}
			}
		}
