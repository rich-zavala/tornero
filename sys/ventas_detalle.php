...
<center>
    <table border="0" align="center" cellpadding="4" cellspacing="0" class="bordear_tabla">
      ...
      <tr>
        ...
        <td>
			<?php
			if(is_numeric($r['metodoDePago']))
			{
				switch($r['metodoDePago'])
				{
					case '01': echo "Efectivo"; break;
					case '02':echo "Cheque"; break;
					case '03':echo "Transferencia"; break;
					case '04':echo "Tarjeta de Crédito"; break;
					case '05':echo "Monedero Electrónico"; break;
					case '06':echo "Dinero Electrónico"; break;
					case '07':echo "Tarjeta Digitales"; break;
					case '08':echo "Vales de Despensa"; break;
					case '09':echo "Bienes"; break;
					case '10':echo "Servicios"; break;
					case '11':echo "Por cuenta de Terceros"; break;
					case '12':echo "Dación en Pago"; break;
					case '13':echo "Pago por Subrogación"; break;
					case '14':echo "Pago por Consignación"; break;
